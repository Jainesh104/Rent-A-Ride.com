...
<title>Rent A Ride | Vehicle Details</title>
<!--Bootstrap -->
...
<link rel="shortcut icon" href="assets/images/favicon-icon/favicons.png">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="date" id="fromdate-date" class="form-control" name="fromdate" placeholder="From Date" required>
            </div>
            <div class="form-group">
              <label>To Date:</label>
              <input type="date" id="todate-date" class="form-control" name="todate" placeholder="To Date" required>
            </div>
<script>
...
var fromdateElem = document.querySelector("#fromdate-date");
var todateElem = document.querySelector("#todate-date");

fromdateElem.setAttribute("min", dateTomorrow);

fromdateElem.onchange = function () {
    todateElem.setAttribute("min", this.value);
}
